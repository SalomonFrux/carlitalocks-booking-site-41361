            ...
            <CardContent className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Djidjolé — en venant de Totsi, prendre la 2ᵉ rue à droite après le commissariat du 6ᵉ arrondissement, puis continuer sur 50 mètres, l'institut se trouve à droite.</p>
